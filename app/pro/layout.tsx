...
const IC = {
  ...
  Star: (p: any) => <svg width={p.s||20} height={p.s||20} viewBox="0 0 24 24" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke={p.c||'currentColor'} strokeWidth="1.7" strokeLinejoin="round"/></svg>,
...
export default function ProLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: C.bg, fontFamily: 'Poppins, sans-serif' }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          .pro-main { margin-left: 0 !important; padding: 72px 14px 80px !important; width: 100% !important; max-width: 100% !important; overflow-x: hidden !important; }
      ...
      <main className="pro-main" style={{ marginLeft: 248, flex: 1, padding: '24px', minWidth: 0, maxWidth: 'calc(100vw - 248px - 300px)', boxSizing: 'border-box' }}>
        {children}
      </main>
