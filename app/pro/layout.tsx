...
const IC = {
  Jobs: (p: any) => (
    <svg width={p.s || 20} height={p.s || 20} viewBox="0 0 24 24" fill="none">
      <rect x="3" y="4" width="18" height="16" rx="2.5" stroke={p.c || '#fff'} strokeWidth="1.7" />
      <path d="M8 4V3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v1" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
      <path d="M8 11h3M8 15h6" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
      <circle cx="16" cy="11" r="1.5" fill={p.c || '#fff'} />
    </svg>
  ),
  Market: (p: any) => (
    <svg width={p.s || 20} height={p.s || 20} viewBox="0 0 24 24" fill="none">
      <circle cx="11" cy="11" r="7" stroke={p.c || '#fff'} strokeWidth="1.7" />
      <path d="M20 20l-3-3" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
      <path d="M11 8v3h3" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  ),
  History: (p: any) => (
    <svg width={p.s || 20} height={p.s || 20} viewBox="0 0 24 24" fill="none">
      <path d="M12 8v4l2.5 2.5" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
      <path d="M3.1 11A9 9 0 1 0 4 8" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
      <path d="M3 5v3h3" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  Profile: (p: any) => (
    <svg width={p.s || 20} height={p.s || 20} viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="8" r="4" stroke={p.c || '#fff'} strokeWidth="1.7" />
      <path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  ),
  Logout: (p: any) => (
    <svg width={p.s || 18} height={p.s || 18} viewBox="0 0 24 24" fill="none">
      <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" />
      <path d="M16 17l5-5-5-5M21 12H9" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  Menu: (p: any) => (
    <svg width={p.s || 22} height={p.s || 22} viewBox="0 0 24 24" fill="none">
      <path d="M4 6h16M4 12h16M4 18h16" stroke={p.c || '#fff'} strokeWidth="2" strokeLinecap="round" />
    </svg>
  ),
  X: (p: any) => (
    <svg width={p.s || 22} height={p.s || 22} viewBox="0 0 24 24" fill="none">
      <path d="M18 6L6 18M6 6l12 12" stroke={p.c || '#fff'} strokeWidth="2" strokeLinecap="round" />
    </svg>
  ),
  Camera: (p: any) => (
    <svg width={p.s || 18} height={p.s || 18} viewBox="0 0 24 24" fill="none">
      <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" stroke={p.c || '#fff'} strokeWidth="1.7" strokeLinejoin="round" />
      <circle cx="12" cy="13" r="4" stroke={p.c || '#fff'} strokeWidth="1.7" />
    </svg>
  ),
  Map: (p: any) => (
    <svg width={p.s || 16} height={p.s || 16} viewBox="0 0 24 24" fill="none">
      <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" stroke={p.c || C.blue} strokeWidth="1.7" />
      <circle cx="12" cy="9" r="2.5" stroke={p.c || C.blue} strokeWidth="1.7" />
    </svg>
  ),
  Dollar: (p: any) => (
    <svg width={p.s || 16} height={p.s || 16} viewBox="0 0 24 24" fill="none">
      <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" stroke={p.c || C.green} strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  ),
  Shield: (p: any) => (
    <svg width={p.s || 16} height={p.s || 16} viewBox="0 0 24 24" fill="none">
      <path d="M12 2L3 7v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V7l-9-5z" fill={p.c || C.green} opacity="0.15" stroke={p.c || C.green} strokeWidth="1.7" />
      <path d="M9 12l2 2 4-4" stroke={p.c || C.green} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  Star: (p: any) => (
    <svg width={p.s || 14} height={p.s || 14} viewBox="0 0 24 24" fill={C.warning}>
      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
    </svg>
  ),
  Clock: (p: any) => (
    <svg width={p.s || 13} height={p.s || 13} viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="9" stroke={p.c || C.muted} strokeWidth="1.7" />
      <path d="M12 7v5l3 3" stroke={p.c || C.muted} strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  ),
  Check: (p: any) => (
    <svg width={p.s || 16} height={p.s || 16} viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="9" stroke={p.c || '#fff'} strokeWidth="1.7" />
      <path d="M9 12l2 2 4-4" stroke={p.c || '#fff'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  Card: (p: any) => (
    <svg width={p.s || 16} height={p.s || 16} viewBox="0 0 24 24" fill="none">
      <rect x="2" y="5" width="20" height="14" rx="3" stroke={p.c || C.blue} strokeWidth="1.7" />
      <path d="M2 10h20" stroke={p.c || C.blue} strokeWidth="1.7" />
      <path d="M6 15h4" stroke={p.c || C.blue} strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  ),
  Arrow: (p: any) => (
    <svg width={p.s || 14} height={p.s || 14} viewBox="0 0 24 24" fill="none">
      <path d="M9 18l6-6-6-6" stroke={p.c || C.muted} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
};
...
function AddressMapCard({ booking, onClose }: { booking: any; onClose: () => void }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 200, display: 'flex', alignItems: 'flex-end', justifyContent: 'flex-end', pointerEvents: 'none' }}>
      <div style={{ width: 320, margin: '0 16px 16px 0', background: '#fff', borderRadius: 18, boxShadow: '0 12px 48px rgba(13,55,129,0.22)', overflow: 'hidden', pointerEvents: 'all', border: `1px solid ${C.border}`, animation: 'slideUp 0.25s ease' }}>
        ...
        <div style={{ padding: '14px 16px' }}>
          ...
          {booking.payout_amount && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 800, color: C.greenDk }}>
                +${Number(booking.payout_amount).toFixed(2)}
              </span>
            </div>
          )}
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <div style={{ background: `linear-gradient(135deg, ${C.navy}, ${C.blue})`, borderRadius: 16, padding: '16px 18px', color: '#fff', boxShadow: '0 6px 24px rgba(13,55,129,0.25)' }}>
        ...
        <div style={{ fontSize: 30, fontWeight: 800, fontFamily: 'Poppins, sans-serif', marginBottom: 12 }}>
          ${earnings.toFixed(2)}
        </div>
      ...
      <div style={{ background: '#fff', borderRadius: 14, border: `1px solid ${C.border}`, padding: '12px 14px' }}>
        ...
        {[
          ...
          <Link key={item.label} href={item.href} style={{ textDecoration: 'none' }}>
            <div
              style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '7px 9px', borderRadius: 9, marginBottom: 5, background: item.bg, cursor: 'pointer', transition: 'opacity 0.15s' }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
            {active.slice(0, 5).map((b) => {
              ...
              return (
                <div
                  key={b.id}
                  onClick={() => onSelectBooking(isSel ? null : b)}
                  style={{ background: isSel ? `${C.blue}08` : C.bg, borderRadius: 11, border: `1px solid ${isSel ? C.blue : C.border}`, padding: '9px 11px', cursor: 'pointer', transition: 'all 0.15s' }}
                >
                  ...
                  {b.payout_amount && (
                    <div style={{ marginTop: 4, fontSize: 12, fontWeight: 800, color: C.greenDk }}>
                      +${Number(b.payout_amount).toFixed(2)}
                    </div>
                  )}
                  {isSel && (
                    <div style={{ marginTop: 6, fontSize: 10, color: C.blue, fontWeight: 600, textAlign: 'center' }}>
                      📍 Tap again to view map
                    </div>
                  )}
                </div>
              );
      ...
      <div style={{ background: '#fff', borderRadius: 14, border: `1px solid ${C.border}`, padding: '12px 14px' }}>
        ...
        {[
          ...
          { label: 'Payment Setup', href: '/pro/payments', icon: <IC.Card c="#7C3AED" s={16} />, bg: '#EDE9FE' },
        ].map((item) => (
          <Link key={item.href} href={item.href} style={{ textDecoration: 'none' }}>
            <div
              style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 10px', borderRadius: 10, marginBottom: 5, border: `1px solid ${C.border}`, cursor: 'pointer', transition: 'background 0.15s' }}
