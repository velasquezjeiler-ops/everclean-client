    ...
    <div style={{ width: '100%', fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 20 }}>
        {[
          ...
          { label: 'Active Jobs', val: active.length, gradient: `linear-gradient(135deg, ${C.blue}, ${C.navy})`, icon: 'A' },
          { label: 'Completed', val: completed.length, gradient: 'linear-gradient(135deg, #7C3AED, #5B21B6)', icon: 'C' },
        ].map(s => (
      ...
      <div style={{ background: '#fff', borderRadius: 16, border: `1px solid ${C.border}`, padding: 18, boxShadow: '0 2px 12px rgba(13,55,129,0.06)' }}>
        ...
        {myJobs.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '40px 16px' }}>
            <div style={{ fontSize: 13, fontWeight: 800, color: C.muted, marginBottom: 10 }}>NO JOBS</div>
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: C.blue, fontSize: 11, fontWeight: 500 }}>
                          ...
                          <a
                            ...
                            style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 260, color: C.blue, textDecoration: 'none' }}
                          >
                            {job.address}
                            {job.city ? `, ${job.city}` : ''}
                          </a>
