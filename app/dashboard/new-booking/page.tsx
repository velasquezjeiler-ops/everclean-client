...
const SERVICE_TYPES = ['HOUSE_CLEANING','DEEP_CLEANING','MOVE_IN_OUT','OFFICE_CLEANING','COMMERCIAL_CLEANING','POST_CONSTRUCTION','MEDICAL_CLEANING','CARPET_CLEANING','INDUSTRIAL','LAUNDRY_PICKUP','CAR_WASH','DRY_CLEANING','PRESSURE_WASHING','WINDOW_CLEANING','ORGANIZING'];
